...
urlpatterns = [
    ...
    url(r'^about/$',
        ...
        name='about'),
    url(r'^resources/$',
        TemplateView.as_view(template_name='resources.html'),
        name='resources'),
    url(r'^contact/$',
        TemplateView.as_view(template_name='contact.html'),
        name='contact'),
    url(r'^Blogpost/(?P<slug>[-\w]+)/$', views.blogpost_detail,
        name='blogpost_detail'),
    url(r'^Blogpost/(?P<slug>[-\w]+)/edit/$',
    ...
    url(r'^accounts/create_blog/$',
        views.create_blog,
        name='registration_create_blog'),
